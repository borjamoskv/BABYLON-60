...
- **Density over Volume:** A lower-parameter model (Inference_L1_Node / Flash) trained strictly on high-quality literature (textbooks, papers, audited Causal-Determinist code) exhibits marginal inference friction compared to massive models trained on noise.
