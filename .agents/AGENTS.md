...
- **Ω138 · MACOS TAHOE METAL SHADER COMPILER INVARIANT (MTLCOMPILERSERVICE):** Queda refutada empíricamente la hipótesis de purga Jetsam/cornerMask OOM. Los colapsos en Chromium/Electron bajo macOS Tahoe (Darwin 26+) en la versión 26.5.2 derivan del fallo del servicio de compilación de shaders de Metal (`MTLCompilerService.xpc`, `namespace: METAL`, `SIGABRT`) al procesar pipelines de GPU/Skia vía Chrome Helper. Toda mitigación temporal mediante `--disable-gpu` desactiva el compositor Metal evitando el crash del servicio, pero la resolución de causa raíz exige la purga de la caché de shaders de Metal (`~/Library/Caches/com.apple.metal`) y la actualización del SDK de Electron. [CORTEX-TAINT:borjamoskv:learn_interceptor:2026-07-23T02:14:00Z:omega_138_v2]
