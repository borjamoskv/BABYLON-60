...
export const HouseVisualizer: React.FC = () => {
	...
	const globalIntensity = visualizerData.reduce((acc, curr) => acc + curr, 0) / numBars;
	...
	return (
		<AbsoluteFill style={{ backgroundColor: '#0A0A0A', justifyContent: 'center', alignItems: 'center', overflow: 'hidden' }}>
			<Audio src={audioFile} />
			...
			<div style={{
				...
				<h1 style={{ margin: 0, fontSize: '3rem', textShadow: '0 0 20px #2B3BE5' }}>
					MOSKV-1 // CLAUDE SCIENCE HOUSE
				</h1>
				<h2 style={{ margin: '10px 0 0 0', fontSize: '1.5rem', color: '#EC4899', textShadow: '0 0 10px #EC4899' }}>
