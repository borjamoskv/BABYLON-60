...
- [ ] **IDE**: motor de inferencia local (TRANSFORMERS vía MLX/llama.cpp) — requiere capa Tauri v2/Rust (MOSKV-1-apex); fuera del runtime FastAPI actual. La búsqueda BM25 es el puente léxico determinista hasta entonces.
