...
- SOVEREIGN TIER: 100% Free and Open-Source for individuals, independent developers, and non-commercial usage. See `docs/COMMERCIAL_LICENSE.md`.
- ENTERPRISE TIER: Corporate and commercial exploitation requires an explicit cryptographic license key (`CORTEX_LICENSE_KEY`) to lift thermodynamic throughput constraints. No permissive grant (MIT, Apache 2.0) is implied for commercial entities.
