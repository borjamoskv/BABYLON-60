...
-- Designed for 128-byte Cache-Line Coherence in SharedManifest FFI (C-ABI) on Apple Silicon / macOS.
-- Text fields replaced by pure functions to guarantee absolute Zero Anergía.
data Primitive = Primitive
  { primKind       :: !FundamentalPrimitive
  -- 128-byte L1 Cache Line Alignment (16 x Unboxed Word64) to prevent False Sharing in macOS Ring-0 IPC
  , primHashPart1  :: !Word64
  , primHashPart2  :: !Word64
  , primHashPart3  :: !Word64
  , primHashPart4  :: !Word64
  , primHashPart5  :: !Word64
  , primHashPart6  :: !Word64
  , primHashPart7  :: !Word64
  , primHashPart8  :: !Word64
  , primHashPart9  :: !Word64
  , primHashPart10 :: !Word64
  , primHashPart11 :: !Word64
  , primHashPart12 :: !Word64
  , primHashPart13 :: !Word64
  , primHashPart14 :: !Word64
  , primHashPart15 :: !Word64
  , primHashPart16 :: !Word64
  } deriving (Eq, Show)
