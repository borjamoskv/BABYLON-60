...
export const IdeLayout: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', width: '100vw', backgroundColor: 'var(--surface, #0F1226)' }}>
      {/* 1. Árbol de archivos / Sidebar del Editor (15%) */}
      <div style={{ width: '15%', borderRight: '1px solid var(--border, #2E3866)' }}>
        <h3 style={{ color: 'var(--text, #FFF)', padding: '1rem' }}>Workspace</h3>
