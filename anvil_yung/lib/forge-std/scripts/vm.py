...
CHEATCODES_JSON_URL = (
    "https://raw.githubusercontent.com/foundry-rs/foundry/master/crates/cheatcodes/assets/cheatcodes.json"
)
OUT_PATH = "src/Vm.sol"
VM_SAFE_DOC = ""
VM_DOC = ""
...
def main():
    ...
    out += VM_SAFE_DOC
    vm_safe = Cheatcodes(
        errors=[], events=contract.events, enums=contract.enums, structs=contract.structs, cheatcodes=safe
    )
