...
class TestDeliverabilityValidator(unittest.TestCase):
    def test_valid_syntax(self) -> None:
        ...
        self.assertTrue(
            DeliverabilityValidator.validate_syntax("alex@foundersfund.com")
        )
    ...
    def test_extract_domain(self) -> None:
        self.assertEqual(
            DeliverabilityValidator.extract_domain("user@gmail.com"), "gmail.com"
        )
        self.assertEqual(DeliverabilityValidator.extract_domain("bad_email"), "")

    def test_validate_email(self) -> None:
        res = DeliverabilityValidator.validate_email(
            "contact@gmail.com", verify_dns=False
        )
