...
DOMAINS = {0: 'ENERGY_BOUND', 1: 'ATTRACTOR_DECAY', 2: 'COGNITIVE_DRIFT', 3: 'RESOURCE_EXHAUST', 4: 'SYBIL_REVERB', 5: 'BAYESIAN_FREE_ENERGY', 6: 'LATENT_TORQUE', 7: 'SURPRISAL_GATE', 8: 'TEMPORAL_PHASE', 9: 'DEEP_MCTS_DEPTH'}
PRIMITIVES = {0: 'HOMEOSTASIS_INIT', 1: 'HOMEOSTASIS_MUTATE', 2: 'PREDICTION_GENERATE', 3: 'PREDICTION_AUDIT', 4: 'ATTENTION_FOCUS', 5: 'ATTENTION_QUANTIZE', 6: 'ACTION_DISPATCH', 7: 'ACTION_ASSERT', 8: 'LANGUAGE_COLLAPSE', 9: 'LANGUAGE_FLUSH'}
