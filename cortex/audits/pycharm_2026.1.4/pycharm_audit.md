...
- **Base:** JVM (Java Virtual Machine).
- **Anergía:** Tiempo de indexación inicial bloqueante. Presión sobre la caché L3 y Garbage Collection (Stop-The-World) aleatorio que interrumpe el RT-Audio y el Vibe Code.
