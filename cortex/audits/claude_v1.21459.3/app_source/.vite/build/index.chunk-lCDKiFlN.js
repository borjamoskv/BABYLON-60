...
`};b(f);const T=e=>{const t=`**Tier packing:** Compute total width BEFORE placing. Example — 4 pub/sub consumer boxes:
...
</html>`}const I=["diagram","mockup","interactive","data_viz","art","chart","elicitation"],L=["mobile","desktop","unknown"];function D(e){const t=b(e),n=T(e),a=k(e);return{diagram:[i,t,n],mockup:[a,i,g],interactive:[a,i,g],data_viz:[a,i,u,m],art:[t,C],chart:[a,i,u,m],elicitation:[S]}}const l="ui://imagine/show-widget.html",M=[{name:"show_widget",description:`Show visual content — SVG graphics, diagrams, charts, or interactive HTML widgets — that renders inline alongside your text response.
