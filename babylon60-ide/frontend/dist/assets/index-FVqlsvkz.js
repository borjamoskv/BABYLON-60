(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const o of l.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function a(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function n(s){if(s.ep)return;s.ep=!0;const l=a(s);fetch(s.href,l)}})();const Ie="";async function x(t){const e=await fetch(`${Ie}${t}`);if(!e.ok){const a=await e.json().catch(()=>({detail:e.statusText}));throw new Error(a.detail||e.statusText)}return e.json()}async function T(t,e){const a=await fetch(`${Ie}${t}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!a.ok){const n=await a.json().catch(()=>({detail:a.statusText}));throw new Error(n.detail||a.statusText)}return a.json()}function Me(t,e,a){const n=location.protocol==="https:"?"wss:":"ws:",s={closed:!1,ws:null},l=()=>{if(s.closed)return;const o=new WebSocket(`${n}//${location.host}${t}`);s.ws=o,o.onmessage=u=>{let r;try{r=JSON.parse(u.data)}catch{return}e(r)},o.onerror=u=>a==null?void 0:a(u),o.onclose=()=>{s.closed||setTimeout(l,3e3)}};return s.close=()=>{var o;s.closed=!0;try{(o=s.ws)==null||o.close()}catch{}},l(),s}const H={};let P=null;function O(t,e){H[t]=e}function b(t){if(P===t)return;P=t,document.querySelectorAll(".nav-item").forEach(a=>{a.classList.toggle("active",a.dataset.route===t)});const e=document.getElementById("main-content");H[t]&&(e.innerHTML="",H[t](e)),history.replaceState(null,"",`#${t}`)}function se(){const t=document.getElementById("main-content");P&&H[P]&&t&&(t.innerHTML="",H[P](t))}function Ce(){const t=location.hash.replace("#","");return t&&H[t]?t:"ledger"}const ae={"2e":{key:"2e",label:"2E ◐",name:"Doble Excepcionalidad (TDAH + AACC)",tachometer:!0,loopGuard:!0,restoreBanner:!0,rewards:!0,spineLabels:!1},nt:{key:"nt",label:"NT ○",name:"Neurotípico",tachometer:!1,loopGuard:!1,restoreBanner:!1,rewards:!1,spineLabels:!0}};function $(){return ae[i.cognitiveMode]||ae["2e"]}function Le(t){try{const e=JSON.parse(t||"[]");return Array.isArray(e)?e:[]}catch{return[]}}const i={cognitiveMode:localStorage.getItem("b60-cogmode")||"2e",contextPaneOpen:!0,bifocalMode:"micro",tachometerState:"idle",paletteOpen:!1,scratchpadOpen:!1,scratchpadItems:[],scratchpadOffline:Le(localStorage.getItem("b60-scratch-offline")),delegationQueue:Le(localStorage.getItem("b60-delegation")),databaseList:[],ledgerStats:null,lastVerify:null,sentinel:null,sentinelModalShown:!1,telemetrySnapshot:null,telemetrySocket:null,loopDetector:{route:null,routeEnteredAt:0,interventionFired:!1},sessionStart:Date.now(),activeRoute:null,swarmLog:[],canvasVB:{x:80,y:40,w:720,h:400},canvasAbort:null};document.addEventListener("DOMContentLoaded",async()=>{Be(i.cognitiveMode,{silent:!0}),f("indexing"),Te(),He(),Re(),Ue(),Ye(),Ke(),ze(),Oe(),Fe(),await Promise.all([Ae(),Qe(),De(),ce()]),le(),z(),f("done"),$().restoreBanner&&Ge(localStorage.getItem("b60-route")||"ledger"),b(Ce()),f("idle")});function Be(t,{silent:e=!1}={}){i.cognitiveMode=ae[t]?t:"2e",localStorage.setItem("b60-cogmode",i.cognitiveMode),document.body.classList.toggle("mode-2e",i.cognitiveMode==="2e"),document.body.classList.toggle("mode-nt",i.cognitiveMode==="nt");const a=document.getElementById("btn-cogmode");a&&(a.textContent=$().label,a.title=`Modo cognitivo: ${$().name} — click o ⌘⇧E para alternar`),e||(Te(),se(),W({icon:$().key==="2e"?"◐":"○",message:`Modo cognitivo: ${$().name}. ${$().key==="2e"?"Tacómetro ambiental (carga del agente en visión periférica), loop-guard (freno de hiperfoco) y micro-recompensas activos.":"Interfaz estándar: navegación etiquetada, sin intervenciones ni señales ambientales."}`}),setTimeout(I,3e3))}function ie(){Be(i.cognitiveMode==="2e"?"nt":"2e")}function Oe(){var e;let t=document.getElementById("btn-cogmode");if(!t){const a=(e=document.getElementById("btn-bifocal"))==null?void 0:e.parentElement;if(a){const n=document.createElement("div");n.className="status-segment",n.innerHTML='<button class="status-bifocal" id="btn-cogmode"></button>',a.parentElement.insertBefore(n,a),t=n.querySelector("#btn-cogmode")}}t&&(t.textContent=$().label,t.title=`Modo cognitivo: ${$().name} — click o ⌘⇧E para alternar`,t.addEventListener("click",ie))}function f(t){i.tachometerState=t;const e=document.getElementById("tachometer");e&&(e.className=`tachometer ${t!=="idle"?t:""}`);const a=document.getElementById("status-agent-segment");if(a)if(t==="working"||t==="indexing"){a.style.display="flex";const n=document.getElementById("status-agent-text");n&&(n.textContent=t==="indexing"?"Indexing context...":"Agent working...")}else a.style.display="none"}const _e=[{id:"canvas",icon:"⬡",label:"Canvas",tip:"Architecture Canvas — ABSTRAER  ⌘5"},{id:"ledger",icon:"⧉",label:"Ledger",tip:"BFT Ledger — DETERMINAR  ⌘1"},{id:"databases",icon:"⛁",label:"Ontologies",tip:"Ontologies (explorador SQLite)  ⌘2"},{id:"query",icon:"❯_",label:"SQL",tip:"SQL Console (solo lectura)  ⌘3"},{id:"swarm",icon:"⚡",label:"Swarm",tip:"Agent Swarm (telemetría en vivo)  ⌘4"},{id:"analytics",icon:"∿",label:"Analytics",tip:"Ledger Analytics — DETERMINAR (agregación + BM25)  ⌘7"},{id:"sentinel",icon:"⎇",label:"Sentinel",tip:"Git Sentinel (identidad de repo + delegación real)  ⌘6"}];function Te(){const t=document.getElementById("spine");if(!t)return;t.innerHTML="";const e=document.createElement("div");e.className="spine-logo",e.title="BABYLON·60 v1.4.0",e.innerHTML='<div class="spine-logo-dot"></div>',t.appendChild(e);const a=$().spineLabels;_e.forEach((n,s)=>{if(s===1){const o=document.createElement("div");o.className="spine-separator",t.appendChild(o)}const l=document.createElement("button");l.className="spine-icon",l.dataset.route=n.id,a||(l.dataset.tooltip=n.tip),l.setAttribute("aria-label",n.tip),l.innerHTML=a?`<span class="spine-glyph">${n.icon}</span><span class="spine-label">${n.label}</span>`:n.icon,l.addEventListener("click",()=>b(n.id)),t.appendChild(l)}),ke(i.activeRoute)}function ke(t){document.querySelectorAll(".spine-icon").forEach(e=>{e.classList.toggle("active",e.dataset.route===t)})}function He(){var t;(t=document.getElementById("btn-collapse-ctx"))==null||t.addEventListener("click",oe),z()}function oe(){i.contextPaneOpen=!i.contextPaneOpen;const t=document.getElementById("context-pane"),e=document.getElementById("btn-collapse-ctx");t&&(t.classList.toggle("collapsed",!i.contextPaneOpen),e&&(e.textContent=i.contextPaneOpen?"⟨":"⟩"))}function z(){var n,s,l,o,u;const t=document.getElementById("context-pane-body");if(!t)return;const e=i.databaseList.slice(0,5).map(r=>`
  ...
  `;try{const e=await x("/api/databases");i.databaseList=e,K();const a=document.getElementById("db-table-body"),n=document.getElementById("db-total-count"),s=document.getElementById("db-total-size");if(n&&(n.textContent=e.length),s){const o=e.reduce((u,r)=>u+(r.size_bytes||0),0);s.textContent=o>1e6?`${(o/1e6).toFixed(1)} MB`:`${(o/1024).toFixed(0)} KB`}const l=o=>o.includes("ledger")?"LEDGER":o.includes("ontology")?"ONTOLOGY":o.includes("memory")||o.includes("cortex")?"CORTEX":o.includes("telemetry")?"TELEMETRY":o.includes("nexus")?"NEXUS":"GENERAL";a&&(a.innerHTML=e.map(o=>`
    ...
    `).join(""),n.querySelectorAll("[data-table]").forEach(o=>{o.addEventListener("click",()=>tt(t,o.dataset.table))})}catch(l){n.innerHTML=`<span style="color:var(--break);font-size:0.68rem">${d(l.message)}</span>`}}}async function tt(t,e){const a=document.getElementById("db-browse-panel"),n=document.getElementById("db-browse-title"),s=document.getElementById("db-browse-meta"),l=document.getElementById("db-schema-body"),o=document.getElementById("db-rows-body");if(!(!a||!o)){a.style.display="block",n&&(n.textContent=`${t} › ${e}`),l&&(l.textContent="Loading schema..."),o.innerHTML="",k({breadcrumb:A("BABYLON·60","Ontologies",t,e)});try{const[u,r]=await Promise.all([x(`/api/databases/${encodeURIComponent(t)}/schema/${encodeURIComponent(e)}`),x(`/api/databases/${encodeURIComponent(t)}/tables/${encodeURIComponent(e)}?limit=25`)]);l&&(l.innerHTML=u.map(m=>`<span style="margin-right:12px;white-space:nowrap">${m.pk?"⚿":"·"} ${d(m.name)} <span style="color:var(--dust-ghost)">${d(m.type||"")}</span></span>`).join("")),s&&(s.textContent=`${r.total} rows total · showing ${r.rows.length}`),r.rows.length===0?o.innerHTML='<div style="color:var(--dust-ghost);font-size:0.68rem;padding:8px">Empty table.</div>':o.innerHTML=`
        <table class="data-table">
          <thead><tr>${r.columns.map(m=>`<th>${d(m)}</th>`).join("")}</tr></thead>
          <tbody>${r.rows.map(m=>`
            <tr>${r.columns.map(c=>{let p=m[c];p==null&&(p="—"),p=String(p);const E=p.length>90?p.slice(0,90)+"…":p;return`<td title="${d(p.slice(0,400))}" style="max-width:260px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${d(E)}</td>`}).join("")}</tr>
          `).join("")}</tbody>
        </table>
      `}catch(u){o.innerHTML=`<div style="color:var(--break);font-size:0.7rem;padding:8px">${d(u.message)}</div>`}}}async function at(t){var a,n,s;_("query"),k({breadcrumb:A("BABYLON·60","SQL Console")}),i.databaseList.length===0&&await Ae(),t.innerHTML=`
  ...
  `;const e=async()=>{var c,p,E;const l=(p=(c=document.getElementById("query-input"))==null?void 0:c.value)==null?void 0:p.trim(),o=(E=document.getElementById("query-db-select"))==null?void 0:E.value;if(!l||!o)return;f("working");const u=document.getElementById("query-result-card"),r=document.getElementById("query-result-body"),m=document.getElementById("query-result-meta");u&&(u.style.display="block"),r&&(r.innerHTML='<div style="color:var(--dust-faint);padding:10px">Running...</div>');try{const v=await T("/api/query",{database:o,sql:l}),h=v.rows||[],R=v.columns||[];m&&(m.textContent=`${v.row_count??h.length} rows${v.truncated?" (truncado a 1000 — afina la consulta)":""} · ${v.elapsed_ms??"—"}ms · ${v.database}`),r&&(h.length===0?r.innerHTML='<div style="color:var(--dust-faint);padding:10px">No results</div>':r.innerHTML=`
            <table class="data-table">
          ...
          `),f("done"),setTimeout(()=>f("idle"),2e3)}catch(v){r&&(r.innerHTML=`<div style="color:var(--break);padding:10px">Error: ${d(v.message)}</div>`),f("idle")}};(a=document.getElementById("btn-run-query"))==null||a.addEventListener("click",e),(n=document.getElementById("btn-clear-query"))==null||n.addEventListener("click",()=>{const l=document.getElementById("query-input");l&&(l.value="");const o=document.getElementById("query-result-card");o&&(o.style.display="none")}),(s=document.getElementById("query-input"))==null||s.addEventListener("keydown",l=>{l.shiftKey&&l.key==="Enter"&&(l.preventDefault(),e())})}async function nt(t){if(_("swarm"),k({breadcrumb:A("BABYLON·60","Agent Swarm"),actions:'<span class="focus-badge live">LIVE</span>'}),t.innerHTML=`
  ...
  `,(o=document.getElementById("btn-sentinel-refresh"))==null||o.addEventListener("click",()=>se()),(u=document.getElementById("delegation-add"))==null||u.addEventListener("click",Se),(r=document.getElementById("delegation-input"))==null||r.addEventListener("keydown",c=>{c.key==="Enter"&&Se()}),(m=document.getElementById("btn-verify-ide-ledger"))==null||m.addEventListener("click",dt),await J()}async function J(){const t=document.getElementById("delegation-list");if(t)try{const e=await x("/api/delegation");ut(e.delegations||[])}catch(e){t.innerHTML=`<div style="color:var(--break);font-size:0.64rem">${d(e.message)}</div>`}}async function Se(){const t=document.getElementById("delegation-input"),e=document.getElementById("delegation-kind"),a=document.getElementById("delegation-status");if(!t||!t.value.trim())return;const n=t.value.trim(),s=(e==null?void 0:e.value)||"custom";try{const l=await T("/api/delegation",{directive:n,kind:s});t.value="",a&&(a.innerHTML=l.cloud_blocked?`<span style="color:var(--gold)">⛔ '${s}' encolado pero bloqueado por P0 — ejecútalo para ver el crash causal.</span>`:`<span style="color:var(--verify)">✓ '${s}' encolado (${l.delegation_id}).</span>`),$().rewards&&(f("done"),setTimeout(()=>f("idle"),1500)),await J()}catch(l){a&&(a.innerHTML=`<span style="color:var(--break)">${d(l.message)}</span>`)}}async function lt(t){const e=document.getElementById("delegation-status");e&&(e.innerHTML=`<span style="color:var(--dust-faint)">Ejecutando ${t}…</span>`);try{const a=await T(`/api/delegation/${t}/execute`,{});if(e&&(e.innerHTML=`<span style="color:var(--verify)">✓ EXECUTED: ${d(a.result||"")}</span>`),$().rewards){const n=document.getElementById("main-content");n==null||n.classList.add("reward-active"),setTimeout(()=>n==null?void 0:n.classList.remove("reward-active"),1400)}}catch(a){e&&(e.innerHTML=`<span style="color:var(--break)">⛔ ${d(a.message)}</span>`),f("alert"),setTimeout(()=>f("idle"),2500)}await J()}async function rt(t){try{await T(`/api/delegation/${t}/cancel`,{})}catch{}await J()}async function dt(){const t=document.getElementById("delegation-status");try{const e=await T("/api/delegation/verify",{});t&&(t.innerHTML=e.valid?`<span style="color:var(--verify)">⚿ IDE CortexLedger íntegro: ${e.verified_entries}/${e.total_entries} eventos, cadena SHA-256 intacta.</span>`:`<span style="color:var(--break)">⚿ Cadena rota en seq ${e.broken_at} (${e.verified_entries}/${e.total_entries}).</span>`)}catch(e){t&&(t.innerHTML=`<span style="color:var(--break)">${d(e.message)}</span>`)}}const ct={QUEUED:"var(--gold)",EXECUTED:"var(--verify)",BLOCKED:"var(--break)",FAILED:"var(--break)",CANCELLED:"var(--dust-ghost)"};function ut(t){const e=document.getElementById("delegation-list");if(!e)return;if(!t||t.length===0){e.innerHTML='<div style="color:var(--dust-ghost);font-size:0.64rem">Cola vacía. El agente no tiene directivas git pendientes.</div>';return}const a=new Set(["push","merge","ship","deploy"]);e.innerHTML=t.map(n=>{const s=n.state==="QUEUED",l=a.has(n.kind);return`
    ...
    </div>`}).join(""),e.querySelectorAll("[data-exec]").forEach(n=>n.addEventListener("click",()=>lt(n.dataset.exec))),e.querySelectorAll("[data-del]").forEach(n=>n.addEventListener("click",()=>rt(n.dataset.del)))}async function mt(t){var n,s,l;_("analytics"),k({breadcrumb:A("BABYLON·60","Ledger Analytics — DETERMINAR"),actions:'<button class="btn" id="btn-analytics-refresh" style="font-size:0.62rem">↺ Refresh</button>'}),t.innerHTML=`
    <div class="card slide-in" style="margin-bottom:14px">
