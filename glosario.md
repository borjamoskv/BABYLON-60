...
| Anergía Ratio A(n) 🌡️ | Instrumento de Falsación | A(n) = 1 - \|{pasos con Δ_disk ≠ ∅}\| / \|{pasos modelo}\|. Métrica termodinámica de output muerto | Ω31 |
| Robinson Refutation 📐 | Isomorfismo Formal | Si A(n) > 0.85 ∧ n > 200 sin ledger BFT → claim refutable (cláusula vacía) | Ω36 |
| detect_sim.py 🔐 | Gate Pre-Ejecución | Escáner determinista de entropía de Shannon, pares monótonos y nibbles secuenciales para bloquear artefactos sintéticos | Ω179 |
| LEXICON.py ⚙️ | Transductor Ontológico | Módulo ejecutable (cortex/lexicon.py) que compila e inspecciona programáticamente el Glosario e Invariantes Ω | Ω179 |
