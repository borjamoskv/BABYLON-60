...
2.  **NSAudioCaptureUsageDescription:** _"Wispr Flow needs to access your computer's audio to take notes during meetings."_ (Allows system/meeting audio capture)
3.  **NSCameraUsageDescription:** _"This app needs access to the camera"_
4.  **NSBluetoothAlwaysUsageDescription & NSBluetoothPeripheralUsageDescription:** _"This app needs access to Bluetooth"_ (Likely for wireless microphones/headsets)
