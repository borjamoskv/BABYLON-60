...
_(Nota: Si usas VS Code/Cursor y sufres esto mismo por el renderizado de Chromium subyacente, añade `"disable-hardware-acceleration": true` en el `argv.json` mediante "Preferences: Configure Runtime Arguments")._
