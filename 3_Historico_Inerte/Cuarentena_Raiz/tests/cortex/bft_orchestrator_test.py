...
import sqlite3
import pytest
from cortex.engines.bft_orchestrator import BFTOrchestrator, DB_PATH, strike_rs
...
class TestBFTOrchestrator(unittest.TestCase):
    ...
    def test_byzantine_fault_recovery(self) -> None:
        ...
        self.assertAlmostEqual(
            self.orchestrator.nodes[2].state_vector.states[0],
            self.orchestrator.nodes[0].state_vector.states[0],
        )
