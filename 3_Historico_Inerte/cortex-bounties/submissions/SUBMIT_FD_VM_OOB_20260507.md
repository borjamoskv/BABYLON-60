# Immunefi Submission: Firedancer VM Sandbox Bypass — Region Index OOB (VM-02)

## Target Information
- **Project:** Firedancer V1 (Solana Independent Validator)
- **Component:** `src/flamenco/vm/fd_vm_private.h` — `fd_vm_mem_haddr`
- **Vulnerability:** Out-of-Bounds Array Access / Sandbox Bypass
- **Severity:** Critical
- **Bounty Pool:** $1M+
...
## 6. Notarization
- **Audit ID**: OUROBOROS-FD-VM-02
- **Timestamp**: 2026-05-05T06:44:00Z
