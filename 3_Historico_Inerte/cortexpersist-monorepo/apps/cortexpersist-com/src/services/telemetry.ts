...
function generateMockTelemetry(): TelemetryData {
  simCycleCount += Math.floor((typeof window !== 'undefined' ? (window._c5_entropy = ((window._c5_entropy || 0.1) * 1.61803398875) % 1) : 0.5) * 5) + 1;
  
  if ((typeof window !== 'undefined' ? (window._c5_entropy = ((window._c5_entropy || 0.1) * 1.61803398875) % 1) : 0.5) > 0.4) {
    ...
    mockLogs.push({
      msg: agents[Math.floor((typeof window !== 'undefined' ? (window._c5_entropy = ((window._c5_entropy || 0.1) * 1.61803398875) % 1) : 0.5) * agents.length)],
      val: actions[Math.floor((typeof window !== 'undefined' ? (window._c5_entropy = ((window._c5_entropy || 0.1) * 1.61803398875) % 1) : 0.5) * actions.length)]
    });
  ...
  return {
    ...
    is_running: (typeof window !== 'undefined' ? (window._c5_entropy = ((window._c5_entropy || 0.1) * 1.61803398875) % 1) : 0.5) > 0.2,
    cycle_count: simCycleCount,
    global_yield: 0.4 + (typeof window !== 'undefined' ? (window._c5_entropy = ((window._c5_entropy || 0.1) * 1.61803398875) % 1) : 0.5) * 0.3,
...
export function connectTelemetry(): void {
  ...
  try {
    sse = new EventSource(`${API_URL}/v1/public/events/stream`);
    ...
    sse.onmessage = (event: MessageEvent) => {
      try {
        ...
        console.error('[TELEMETRY] Parse error');
      }
    };
