...
const DOMAINS = primitivesData.domains || [
  ...
  {
    id: "D4",
    name: "D4: Categorías Monoidales y Enriquecidas",
    range: [337, 448],
  },
...
export const Categorical896MatrixVisualizer: React.FC = () => {
  ...
  const [selectedPrimitiveId, setSelectedPrimitiveId] = useState<number | null>(
    1,
  );
  ...
  const selectedPrimitiveData = allPrimitives.find(
    ...
    >
      ...
      <div
        style={{
          ...
          height: "300px",
          background:
            "radial-gradient(circle, rgba(43,59,229,0.1) 0%, rgba(10,10,10,0) 70%)",
          zIndex: 0,
          pointerEvents: "none",
        }}
      ></div>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          <div>
            ...
            >
              <span
                style={{
                  ...
                  width: "12px",
                  height: "12px",
                  backgroundColor: "#3B4DFF",
                  borderRadius: "2px",
                  boxShadow: "0 0 10px rgba(59, 77, 255, 0.5)",
                }}
              ></span>
            ...
            >
              C5-REAL Transducer Engine · Mapeo Topológico
            </span>
          </div>
          <div
            style={{
            ...
            return (
              <button
                ...
                style={{
                  ...
                  boxShadow: isActive
                    ? "0 4px 12px rgba(59, 77, 255, 0.25)"
                    : "none",
                  outline: "none",
                }}
                onMouseEnter={(e) => {
          ...
          >
            <span>
              ...
              <strong style={{ color: "#FFFFFF" }}>
                {filteredPrimitives.length} Nodes
              </strong>
            </span>
            <span style={{ color: "#3B4DFF" }}>|</span>
            <span>
              {"Complejidad O(1):"}{" "}
              <strong style={{ color: "#10B981" }}>COMPAT(Ω)</strong>
            </span>
          </div>
        </div>
        ...
        {selectedPrimitiveData && (
          ...
          >
            ...
            >
              [P-{String(selectedPrimitiveData.id).padStart(3, "0")}] ::{" "}
              {selectedPrimitiveData.code}
            </div>
            ...
            >
              ...
              >
                Type: {selectedPrimitiveData.type}
              </span>
              <span
                style={{
                  backgroundColor: "#161A36",
              ...
              >
                {selectedPrimitiveData.category}
              </span>
            </div>
