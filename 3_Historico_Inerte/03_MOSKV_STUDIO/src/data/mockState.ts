...
export const INITIAL_SWARM: SwarmNode[] = [
  {
    id: "node-0",
    name: "MOSKV-1 APEX (Leader)",
    role: "Leader / Proposer",
    status: "synced",
    latency: 0.4,
    lamport: 104,
    hash: "7a3f95b...e9",
  ...
  {
    id: "node-1",
    name: "Worker Alpha (Rust Core)",
    role: "Execution Transducer",
    status: "synced",
    latency: 1.2,
    lamport: 104,
    hash: "8a339ce...b5",
  ...
  {
    id: "node-2",
    name: "Worker Beta (Prolog Engine)",
    role: "Unification Verifier",
    status: "synced",
    latency: 1.8,
    lamport: 104,
    hash: "9b440df...c6",
  ...
  {
    id: "node-4",
    name: "Worker Delta (Go Transducer)",
    role: "IPC Buffer & WAL",
    status: "voting",
    latency: 3.4,
    lamport: 104,
