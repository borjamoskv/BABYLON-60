...
from babylon60.extensions.speculative.apotheosis_audits_mixin import ApotheosisAuditsMixin
from babylon60.extensions.temporal.rem_cycle import REMCoordinator
        ...
        try:
            ...
            if actions:
                ...
                if critical_actions and self.is_active:
                    from babylon60.extensions.speculative.keter import KeterEngine
