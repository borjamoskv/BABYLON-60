...
class ChronosEngine:
    ...
    COMPLEXITY_MULTIPLIERS: dict[str, dict[str, float]] = {  # type: ignore[reportAssignmentType]
        "low": {
            ...
            "t_b": 0.5,
            "t_p": 0.0,  # No penalty
            "context": "Un humano habría localizado el archivo, añadido el código básico y probado el output. Tarea procedimental.",  # type: ignore[dict-item]
        },
        "medium": {
            "t_c": 3.0,
            "t_d": 2.0,
            ...
            "t_b": 2.0,
            "t_p": 1.0,
            "context": "Investigación activa en red, lectura profunda de PRs, comprensión arquitectónica antes de transducir 2-3 archivos clave.",  # type: ignore[dict-item]
        },
        "high": {
            "t_c": 5.0,
            "t_d": 5.0,
            ...
            "t_b": 8.0,
            "t_p": 3.0,
            "context": "Refactor sistémico. Un humano se habría bloqueado por cansancio cognitivo y dependencias rotas en cascada.",  # type: ignore[dict-item]
        },
        "god": {
            "t_c": 10.0,
            "t_d": 15.0,
            ...
            "t_b": 15.0,
            "t_p": 5.0,
            "context": "Orquestación sistémica (Swarm/OS). Un humano habría requerido validación adversaria intensiva y debugging existencial profundo.",  # type: ignore[dict-item]
        },
        "impossible": {
            "t_c": 10000000.0,
            "t_d": 40000000.0,
            ...
            "t_b": 30000000.0,
            "t_p": 10000000.0,
            "context": "Singularidad pura. Una labor imposible para un humano. ROI Asintótico.",  # type: ignore[dict-item]
        },
    }
    ...
    def analyze(cls, ai_time_secs: float, complexity: str = "medium") -> ChronosMetrics:
        ...
        return ChronosMetrics(
            ...
            context_msg=multipliers["context"],  # type: ignore[arg-type]
            tip=tip,
            anti_tip=anti_tip,
        )
