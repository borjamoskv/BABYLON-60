...
| `ONC-146` | **Mutational signatures (COSMIC)** | biomarcador | Deconstruccion matematica de perfiles trinucleotidos (catálogo COSMIC v3.4 SBS/ID/CN) que revela las huellas digitales mutacionales de procesos endogenos y exogenos (desaminacion 5mC SBS1, APOBEC SBS2/13, HRD SBS3, tabaco SBS4, UV SBS7). | Permiten inferir la etiologia oncogenica subyacente, estratificar la agresividad tumoral y predecir dianas accionables (ej. firma HRD/SBS3 predice sensibilidad a platino y PARPi). | Alexandrov et al., Nature 2013; Alexandrov et al., Nature 2020 |
| `ONC-147` | **APOBEC mutagenesis** | proceso | Hiperactividad desregulada de enzimas citidina-desaminasas (APOBEC3A/APOBEC3B) sobre ADN de cadena sencilla que catalizan C->T o C->G preferentemente en contextos trinucleotidos TCW (W = A o T). | Genera lluvias mutacionales agrupadas y alto volumen de neoantigenos; su actividad sostenida promueve evolucion clonal, evasión inmunológica y resistencia adquirida a terapias dirigidas. | Swanton et al., Cancer Discov 2015; Bozek et al., Genome Biol 2023 |
| `ONC-148` | **Chromothripsis** | proceso | Evento catastrofico en una sola division celular (a menudo en micronucleos tras segregacion anomala) donde uno o varios cromosomas se fragmentan masivamente y re-ensamblan aleatoriamente por NHEJ/MMEJ propensos a error. | Origina amplificaciones masivas en aglomerados de oncogenes clave (ecDNA que contiene MYC, MDM2, CDK4 o EGFR) al tiempo que deleciona supresores tumorales en los puntos de fractura. | Stephens et al., Cell 2011; Ly et al., Nat Genet 2019 |
