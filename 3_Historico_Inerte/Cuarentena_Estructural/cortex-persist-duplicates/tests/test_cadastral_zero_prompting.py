...
from babylon60.extensions.evo.evolution_metrics import CortexMetrics
from babylon60.extensions.evo.evolution_types import (
    DomainMetrics,
    Mutation,
    SovereignAgent,
    SubAgent,
...
class TestZeroPromptingEvolution:
    def test_fires_on_high_entropy(
        ...
        assert len(result["report_hash"]) == 44
