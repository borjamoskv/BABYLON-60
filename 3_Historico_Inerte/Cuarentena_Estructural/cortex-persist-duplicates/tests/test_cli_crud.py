...
import babylon60.extensions.sync as sync_mod
...
class TestDeleteCommand:
    ...
    def test_delete_existing_fact(self, runner, db_path, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(sync_mod, "MEMORY_DIR", tmp_path / "memory")
        monkeypatch.setattr(sync_mod, "CORTEX_DIR", tmp_path)
        monkeypatch.setattr(sync_mod, "SYNC_STATE_FILE", tmp_path / "sync_state.json")
