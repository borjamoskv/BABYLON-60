...
logger = logging.getLogger("babylon60_extensions.adk.goog_tools")
...
def goog_backup_cortex() -> dict[str, Any]:
    ...
    db_path = Path("~/.babylon60/cortex.db").expanduser()
    ...
    try:
        ...
        snapshot_path = Path("~/.babylon60/context-snapshot.md").expanduser()
