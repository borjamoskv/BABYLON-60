...
async def approve_action(
    ...
    try:
        ...
        raise HTTPException(status_code=410, detail="Internal server error") from None
    except GateInvalidSignature:
        raise HTTPException(status_code=403, detail="Internal server error") from None
    except GateError:
        raise HTTPException(status_code=404, detail="Internal server error") from None
