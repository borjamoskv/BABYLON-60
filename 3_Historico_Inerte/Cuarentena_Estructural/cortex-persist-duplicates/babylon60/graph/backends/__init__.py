...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    "GraphBackend": ("babylon60.graph.backends.base", "GraphBackend"),
    "SQLiteBackend": ("babylon60.graph.backends.sqlite", "SQLiteBackend"),
    "Neo4jBackend": ("babylon60.graph.backends.neo4j_backend", "Neo4jBackend"),
}
