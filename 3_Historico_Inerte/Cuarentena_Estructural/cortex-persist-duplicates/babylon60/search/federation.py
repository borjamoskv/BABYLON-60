...
Enables transparent search across partitioned memory databases:
  - core     → ~/.babylon60/cortex.db (CORTEX infra, IA, tooling)
  - personal → ~/.babylon60/personal_memories.db (side projects)
  - cold     → ~/.babylon60/cold_storage.db (tests, archived junk)
