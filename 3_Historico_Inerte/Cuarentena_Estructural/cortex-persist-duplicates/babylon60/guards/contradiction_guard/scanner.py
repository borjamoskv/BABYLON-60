...
def _compare_decisions(
    ...
    b: dict[str, Any],
    min_score: Decimal,
) -> tuple[Decimal, ConflictCandidate, ConflictCandidate] | None:
...
def _process_token_bucket(
    ...
    pairs: list[tuple[Decimal, ConflictCandidate, ConflictCandidate]],
    min_score: Decimal,
) -> None:
...
async def scan_all_contradictions(
    *,
    ...
    min_score: Decimal = Decimal("0.45"),
    limit: int = 50,
