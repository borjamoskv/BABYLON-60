...
try:
    from babylon60.extensions.health.health_mixin import (
        HealthMixin,  # type: ignore # pyright: ignore[reportAssignmentType]
    )
    from babylon60.extensions.health.models import (  # type: ignore # pyright: ignore[reportAssignmentType]
        Grade,
        HealthSLA,
        HealthSLAViolation,
    )
