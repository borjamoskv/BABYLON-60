...
from babylon60.extensions.evo._mutation_projectors import project
...
class FactMutationEngine:
    ...
    async def apply(
        ...
        *,
        ...
        signature = bytes_to_base60(hashlib.sha3_256(chain_input.encode()).digest())
