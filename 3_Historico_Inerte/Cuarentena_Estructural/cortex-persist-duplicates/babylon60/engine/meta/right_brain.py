...
class HeuristicEngine:
    ...
    def daydream(self, free_energy_state: FreeEnergyState) -> list[dict[str, Any]]:
        ...
        logger.info(
            "C5-REAL: Right-Brain activation triggered. (Surprise: %.4f, Domain: %s)",
            free_energy_state.surprise,
            free_energy_state.domain.name,
        )
        ...
        if insights:
            logger.info("Right-Brain generated %s associative insights.", len(insights))
