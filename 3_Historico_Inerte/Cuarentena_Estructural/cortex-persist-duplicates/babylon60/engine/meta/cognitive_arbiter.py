...
class MetaArbiter:
    ...
    def arbitrate(
        ...
        resolution, winning, reasoning = self._determine_resolution(conflicts, fused_score, signals)
    ...
    def _determine_resolution(
        self, conflicts: list[ConflictPair], fused_score: float, signals: list[LayerSignal]
    ) -> tuple[Resolution, LayerID | None, str]:
        if not conflicts:
        ...
        return resolution, winning, reasoning
