...
# Experimento de Blog para cortexpersist.dev

## Introducción
Este documento describe un **experimento de blog** para el dominio **cortexpersist.dev**. El objetivo es validar la infraestructura de publicación, medir la interacción de los lectores y explorar contenido técnico‑avanzado que refleje la visión de BABYLON-60.
...
| Semana | Acción |
|--------|--------|
| 1 | Configurar repositorio `cortexpersist.dev` y pipeline CI/CD |
