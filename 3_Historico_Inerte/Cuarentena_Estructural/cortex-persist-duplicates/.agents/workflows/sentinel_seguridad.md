...
> "Scan the `Sources/` directory for hardcoded secrets, exposed tokens, or insecure storage practices. Persist findings via the Ledger with a valid CORTEX-TAINT signature."
