...
def print_ablation_summary(
    ...
    logging.getLogger(__name__).info("ENCB v2 - Ablation Study")
    logging.getLogger(__name__).info("=" * 55)
    ...
    for ablation_id, reports in results.items():
        ...
        logging.getLogger(__name__).info(f"{ablation_id:<25} {avg_pfbr:>8.4f} {avg_edi:>12.1f} {cncl_str:>8}")
