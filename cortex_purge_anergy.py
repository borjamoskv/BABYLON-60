...
PROTECTED_FILES = {'.coderabbit.yaml', '.gitattributes', '.gitignore', '.gitmodules', 'AGENTS.md', 'Anergy_Audit.yml', 'COLLAPSE_P0.sh', 'Dockerfile', 'ETHOS.md', 'LEARN_SHIP_ITERATE_INVARIANT.md', 'LICENSE.md', 'LLM_THERMODYNAMICS_LAYERS.md', 'LLM_THERMODYNAMICS_LAYERS_5_8.md', 'MANIFIESTO_CENTURIA.md', 'MOSKV_1_APEX_BLUEPRINT.md', 'Makefile', 'PROJECT.md', 'README.md', 'README_APEX.md', 'SECURITY.md', 'STATUS.md', 'TEXTBOOK_EXERGY_INVARIANT.md', 'VECTOR_A_MASTER_LEDGER_DESIGN.md', 'pyproject.toml', 'uv.lock', 'cortex_purge_anergy.py', 'cortex_ssm_mamba_core.py', 'cortex_mamba_block.py', 'cortex_mamba_network.py', 'cortex_mamba_inference.py', 'cortex_bpe_tokenizer.py', 'core_graph_ledger.py', 'io_persist_ledger.py', 'net_mamba_ledger_engine.py', 'index.html'}
...
def main() -> None:
    ...
    audit_report = {'Claim': 'Root directory Anergy (loose scripts, DBs, and datasets) has been structurally purged and archived, restoring 00_WORKSPACE.md hierarchy invariant.', 'Proof': {'Base': 'sha3_256::cortex_taint', 'Range': [count, count], 'Confidence': 'C5-REAL'}, 'Operator': 'borjamoskv', 'System_Level': 'C5-REAL', 'Anergy_Files_Purged': count, 'Anergy_Bytes_Purged': total_bytes, 'Cortex_Taint': cortex_taint, 'Timestamp': datetime.datetime.now(datetime.timezone.utc).isoformat()}
