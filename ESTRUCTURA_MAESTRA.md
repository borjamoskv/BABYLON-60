...
4. **`1_Operaciones_Activas/scripts/`**: Active operational scripts (`43_iter_ultrathink.py`, `58_thermodynamic_wallpaper_ultrathink.py`, `59_autodidact_omega_deep_research_engine.py`) driving MCTS tree-search and physical hardware entropy ingestion.
