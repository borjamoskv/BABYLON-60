...
def main():
    ...
    if not lib_path:
        print("ERROR: libverifiable_inference_engine no encontrada. Mónada de caos fallida.")
        sys.exit(1)
    ...
    print("[*] Ingestando Cristal y aplicando Filtro Entrópico (Ω27)...")
    ...
    if is_valid:
        print("[*] Tasa de Éxito: 100%. Cristal asimilado en estado C5-REAL.")
