...
from babylon60.extensions.evo.decalcifier import SovereignDecalcifier
from babylon60.extensions.evo.growth import GROWTH_ENGINE
from babylon60.extensions.evo.reaper import GhostReaper
...
class REMCoordinator:
    ...
    async def enter_rem(self) -> None:
        ...
        from babylon60.extensions.evo.evaporator import EntropicEvaporator
