...
def _register_p0_triggers(engine: TriggerEngine) -> None:
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="babylon60.extensions.swarm.worktree_isolation",
        )
    )
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="babylon60.extensions.swarm.swarm_heartbeat",
        )
    )
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="babylon60.extensions.swarm.telemetry_gate",
        )
    )
...
def _register_p1_triggers(engine: TriggerEngine) -> None:
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="babylon60.extensions.swarm.byzantine",
        )
    )
...
def _register_p2_triggers(engine: TriggerEngine) -> None:
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="babylon60.extensions.signals.fact_hook",
        )
    )
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="babylon60.extensions.swarm.error_ghost_pipeline",
        )
    )
