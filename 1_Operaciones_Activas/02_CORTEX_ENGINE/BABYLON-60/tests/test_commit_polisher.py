...
_script_path = Path(__file__).resolve().parent.parent / "scripts" / "commit_polisher.py"
_spec = importlib.util.spec_from_file_location("scripts.commit_polisher", _script_path)
...
sys.modules["scripts.commit_polisher"] = _mod
