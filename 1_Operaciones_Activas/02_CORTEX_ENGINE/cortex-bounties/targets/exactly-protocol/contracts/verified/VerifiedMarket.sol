...
contract VerifiedMarket is Market {
  ...
  /// @return borrowShares The amount of shares borrowed.
  function borrow(
    uint256 assets,
    address receiver,
    address borrower
  ...
  /// @notice Calls super function after requiring sender, receiver and borrower to be allowed.
  /// @param maturity The maturity of the borrow.
  /// @param assets The amount of assets to borrow.
  /// @param maxAssets The maximum amount of assets to borrow.
  /// @param receiver The address to receive the assets.
  /// @param borrower The address of the borrower.
  /// @return assetsOwed The amount of assets owed.
