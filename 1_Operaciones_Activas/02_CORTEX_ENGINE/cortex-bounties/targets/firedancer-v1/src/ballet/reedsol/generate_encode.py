...
def make_encode(min_data_shreds, max_data_shreds, max_parity_shreds):
    ...
    with open(f'fd_reedsol_encode_{n}.c', 'wt') as outf:
        ...
        cprint("   parity_shred_cnt of them though. */")
        ...
        cprint("ulong parity_remaining = parity_shred_cnt - parity_produced;")
        ...
        while potential_parity_remaining>0:
            ...
            cprint("parity_remaining = parity_shred_cnt - parity_produced;")
            cprint("}")
