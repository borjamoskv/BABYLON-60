...
MISC = [
    {
        ...
        "description": "misc caps-in-field",
    },
    *[
        {
            "payload": {
    ...
    *[{"payload": e, "description": "misc irregular payload"} for e in ALL_TYPES],
]
GET_HEALTH = [
    {
...
GET_VERSION = [
    {
        ...
        "description": "getVersion success",
        "exclude_paths": [
            "root['msg']['result']"
...
GET_IDENTITY = [
    {
        ...
        "description": "getIdentity success",
    ...
    *[
        {
            ...
            "description": "getAccountInfo account=",
            "exclude_paths": ["root['msg']['result']['context']['slot']"],
        }
        for e in [
...
GET_BALANCE = [
    {
        ...
        "description": "getBalance account=SysvarRent111111111111111111111111111111111",
        "exclude_paths": ["root['msg']['result']['context']['slot']"],
    },
    *[
        {
...
GET_HEIGHT = [
    {
        ...
        "description": "getBlockHeight success",
...
GET_GENESIS_HASH = [
    {
        ...
        "description": "getGenesisHash success",
    },
    *[
        {
            "payload": {
...
GET_INFLATION_GOVERNOR = [
    {
        ...
        "description": "getInflationGovernor success",
    },
    *[
        {
            "payload": {
...
GET_LATEST_BLOCKHASH = [
    {
        ...
        "description": "getLatestBlockhash success",
    },
]
...
GET_MINIMUM_BALANCE_FOR_RENT_EXEMPTION = [
    {
        ...
        "description": "getMinimumBalanceForRentExemption success",
    },
]
...
GET_TRANSACTION_COUNT = [
    {
        ...
        "description": "getTransactionCount success",
        "exclude_paths": [
            "root['msg']['result']",
        ],  # due to race
    },
...
GET_CLUSTER_NODES = [
    {
        ...
        "description": "getClusterNodes success",
...
GET_EPOCH_INFO = [
    {
        ...
        "description": "getEpochInfo success",
        "exclude_paths": [
