...
fd_mint = Keypair.from_seed_and_derivation_path(top_seed, "m/44'/45'/30'/99999'")
...
nano_mint = Keypair.from_seed_and_derivation_path(top_seed, "m/44'/45'/30'/99996'")
...
def create_accounts_tx(funder, lamports, recent_blockhash, txn_type, accs):
    ...
    for acc in accs:
        ...
        if txn_type == TXN_TYPE_NANO_TOKEN_TRANSFER:
            ...
            Rent.default().minimum_balance(56)
