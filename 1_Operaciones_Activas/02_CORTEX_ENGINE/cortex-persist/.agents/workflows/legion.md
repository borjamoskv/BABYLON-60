...
owner: borjamoskv
exergy_tier: P0
description: "\U0001F531 LEGI\xD8N-1 \u2014 Protocolo de Swarm Soberano y Consenso\
  \ Bizantino en CORTEX"
---
...
La orquestación se invoca mediante el CLI de CORTEX o a través de scripts utilizando la clase [CentauroEngine](file:///Users/borjafernandezangulo/30_BABYLON-60/babylon60/extensions/swarm/centauro_engine.py#L185).
...
La clase [ByzantineConsensus](file:///Users/borjafernandezangulo/30_BABYLON-60/babylon60/extensions/swarm/byzantine.py#L23) procesa las propuestas de ejecución simultáneas mediante las siguientes fases:
...
- **Anti-Sybil Bias (Ω1b):** La aserción de quórum BFT requiere forzosamente un multiplicador de diversidad estructural de modelos (peso de modelos de familias independientes). Queda prohibido el voto directo entre agentes clones in-context o destilaciones idénticas, previniendo la amplificación de rumores estocásticos (Crystallized Rumors).
