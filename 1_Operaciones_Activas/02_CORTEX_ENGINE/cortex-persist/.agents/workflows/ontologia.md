...
owner: borjamoskv
exergy_tier: P1
description: "ONTOLOGIA \u2014 Extrae y visualiza 100 primitivas, 100 invariantes,\
  \ 20 antipatrones, 10 redundancias y 50 vectores adversariales de CORTEX."
---
...
```yaml
Claim: Regeneración y auditoría base ontológica CORTEX-Persist
Constraints: Consolidación exacta de 280 entidades (100 prims, 100 invt, 20 antip, 10 redun, 50 vectors)
```
