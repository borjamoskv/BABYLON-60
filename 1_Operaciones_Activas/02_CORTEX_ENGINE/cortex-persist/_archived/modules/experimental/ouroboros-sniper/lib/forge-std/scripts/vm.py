...
def main():
    ...
    logging.getLogger(__name__).info(f"Wrote to {OUT_PATH}")
...
class Visibility(PyEnum):
    EXTERNAL: str = "external"  # type: ignore
    PUBLIC: str = "public"  # type: ignore
    INTERNAL: str = "internal"  # type: ignore
...
class Mutability(PyEnum):
    PURE: str = "pure"  # type: ignore
    VIEW: str = "view"  # type: ignore
...
class Item(PyEnum):
    ...
    ENUM: str = "enum"  # type: ignore
    STRUCT: str = "struct"  # type: ignore
    FUNCTION: str = "function"  # type: ignore
