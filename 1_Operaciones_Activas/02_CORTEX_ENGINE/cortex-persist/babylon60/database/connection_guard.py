...
_WHITELISTED_MODULES: frozenset[str] = frozenset(
    {
        ...
        "cortex/extensions/temporal/chronos_roi.py",
        "cortex/extensions/evo/decalcifier.py",
        "cortex/engine/core/tuning_store.py",
        "cortex/engine/meta/forgetting_oracle.py",
        "cortex/extensions/speculative/substack_sidecar.py",
        ...
        # Legitimate raw connections additions
        "cortex/ledger/escape_hatch.py",
        "cortex/audit/ledger.py",
        "cortex/extensions/artist_cortex/artist_cortex.py",
    }
)
...
def scan_raw_connects(
    ...
    for py_file in root_path.rglob("*.py"):
        ...
        norm_path = rel_path.replace("babylon60/", "cortex/")
        if any(norm_path.endswith(w) for w in allowed):
            continue
