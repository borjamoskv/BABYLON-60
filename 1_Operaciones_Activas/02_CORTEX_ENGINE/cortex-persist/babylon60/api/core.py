...
app = FastAPI(
    ...
    "**THK-I-042 DISCLAIMER**: The 'thinking_trace' outputs exposed by this API are approximations of the internal reasoning of the models, not literal transcriptions of cognitive state.",
    version=__version__,
    lifespan=lifespan,
