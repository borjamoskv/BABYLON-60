...
class AutoCrystallizer:
    ...
    def crystallize_fact(self, raw_data: str, origin: str | None = None) -> dict[str, Any]:
        """
        1. Purges Anergy.
        ...
        compressed_data = entropy_annihilator.thermodynamically_compress(purged_data, origin=origin)
        ...
        logger.info(
            "[AutoCrystallizer] Fact crystallized. Entropy: %.2f", fact_dict["entropy_score"]
        )
        return frozen_fact
