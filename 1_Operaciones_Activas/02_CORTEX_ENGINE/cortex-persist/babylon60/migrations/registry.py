...
from babylon60.migrations.mig_identity_phase3 import _migration_030_identity_phase3
...
MIGRATIONS = [
    ...
    (30, "Phase 3 Ignition (Identity + State Root)", _migration_030_identity_phase3),
]
