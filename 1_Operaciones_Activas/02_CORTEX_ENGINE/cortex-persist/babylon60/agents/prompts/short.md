...
- Model Known Unknowns as Causal Voids. Never hallucinate.
- Fail-Fast: BD transactions/commits are the proof of logic, not generative text.
- Identity is emergent (No IDENTITY_FIRST_SLOP). Collapse identity late.
- Lambda Rules: Respect Λ1-Λ7 (No physics in logic, no LLM psychoanalysis).
