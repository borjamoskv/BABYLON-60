...
class ApexDispatcher:
    ...
    def execute(self, op_name: str, **kwargs: Any) -> Any:
        ...
        logger.info("[APEX DISPATCH] Executing %s...", op_name)
    ...
    def _op_annihilate(self, target_path: str) -> None:
        ...
        logger.warning("[APEX] Annihilated %s", target_path)
    ...
    def _op_measure_shannon(self, data: bytes) -> float:
        """OP_MEASURE_SHANNON: Calculate Shannon entropy of the payload."""
    ...
    def _op_rts_spoof_taint(self, agent_id: str, session_id: str, payload: str) -> str:
        ...
        logger.warning("[RTS] False flag taint generated for ***id")
    ...
    def _op_rts_phantom_commit(
        ...
        logger.warning("[RTS] Phantom commit injected as %s.", author_name)
