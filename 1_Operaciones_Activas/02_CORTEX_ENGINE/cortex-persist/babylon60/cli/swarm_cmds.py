...
@click.option("--db", default="~/.babylon60/cortex.db", help="Database path")
...
@swarm.command("up")
@click.option("--db", default="~/.babylon60/swarm.db", help="Swarm Bus Database Path")
def swarm_up(db):
...
def swarm_strike(phalanx, target):
    ...
    from babylon60.swarm.squadrons import (
        AutonomousRouter,
        GoldPhalanx,
        LeadPhalanx,
        SilverPhalanx,
