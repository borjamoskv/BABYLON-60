...
def test_secret_redactor_dict():
    payload = {
        "user": "Alice",
        "key": "sk-ant-api03-abcdefg1234567890abcdefg1234567890abcdefg1234567890abcdefg1234567890abcdefg1234567890abcdefg123",
        "nested": {
            "token": "sk-ant-api03-abcdefg1234567890abcdefg1234567890abcdefg1234567890abcdefg1234567890abcdefg1234567890abcdefg123"
        },
    }
...
def test_memory_firewall_high_risk_secret():
    payload = "My token is sk-ant-api03-abcdefg1234567890abcdefg1234567890abcdefg1234567890abcdefg1234567890abcdefg1234567890abcdefg123"
    content, risk, threats = MemoryFirewall.screen_content(payload)
