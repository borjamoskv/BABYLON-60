...
from babylon60.extensions.forensic.forensic_commander import ForensicCommander
from babylon60.extensions.forensic.forensic_strike_config import STRIKE_V1
...
async def test_strike_density_assignment():
    ...
    commander = ForensicCommander(bus_path="runtime.db")
