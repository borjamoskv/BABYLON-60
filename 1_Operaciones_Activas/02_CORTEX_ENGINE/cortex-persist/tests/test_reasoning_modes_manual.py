...
async def test_reasoning_modes():
    ...
    logging.getLogger(__name__).info("Normal Fallbacks:", [p.provider_name for p in fallbacks_normal])
    ...
    logging.getLogger(__name__).info("Ultra Fallbacks:", [p.provider_name for p in fallbacks_ultra])
