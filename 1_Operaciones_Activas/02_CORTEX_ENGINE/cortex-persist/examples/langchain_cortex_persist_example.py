...
def main() -> None:
    ...
    logging.getLogger(__name__).info(f"Hash  : {proof.hash}")
    logging.getLogger(__name__).info(f"Valid : {proof.verify()}")
    logging.getLogger(__name__).info("Session cryptographically sealed. Tamper-evident by construction.")
