...
| Component | Subproject Directory | Focus |
| :--- | :--- | :--- |
| **Root Sovereign Substrate** | [`README.md`](../README.md) | Central overview, architecture diagram, moat pillars, live quickstart. |
...
| **APEX Clinical Copilot** | [`docs/06_theory/`](./06_theory/README_APEX.md) | Deterministic clinical-trial protocol amendment-risk copilot. |
