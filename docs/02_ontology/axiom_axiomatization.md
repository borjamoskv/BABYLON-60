---
title: Axiomatización Formal BABYLON-60 — Motor Causal APEX
...
> Cada escritura a una clave existente incrementa strictly su versión. Las versiones nunca retroceden durante la ejecución normal.
...
El snapshot se captura antes de la primera ejecución.
...
Ver script ejecutable: [`scripts/axiom_verifier_z3.py`](file:///Users/borjafernandezangulo/10_PROJECTS/BABYLON-60/scripts/axiom_verifier_z3.py)
