...
A system is _physically scalable_ (avoids structural necrosis) if and only if the renormalization work is strictly bounded by a fraction of the baseline budget:
