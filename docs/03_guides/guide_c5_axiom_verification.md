...
El kernel **C5-REAL** se rige por 4 axiomas fundamentales documentados en [`AXIOMATIZATION_C5_REAL.md`](file:///Users/borjafernandezangulo/10_PROJECTS/BABYLON-60/docs/06_theory/AXIOMATIZATION_C5_REAL.md):
...
El motor de verificación se implementa en [`axiom_verifier_z3.py`](file:///Users/borjafernandezangulo/10_PROJECTS/BABYLON-60/scripts/c5_verifiers/axiom_verifier_z3.py). Para auditar el cumplimiento axiomático del sistema, ejecuta:
...
Añadir la especificación en KaTeX dentro de [`docs/06_theory/AXIOMATIZATION_C5_REAL.md`](file:///Users/borjafernandezangulo/10_PROJECTS/BABYLON-60/docs/06_theory/AXIOMATIZATION_C5_REAL.md), definiendo:
...
Agregar el método de verificación en la clase `AxiomVerifier` en [`axiom_verifier_z3.py`](file:///Users/borjafernandezangulo/10_PROJECTS/BABYLON-60/scripts/c5_verifiers/axiom_verifier_z3.py):
...
Crear una demostración en `scripts/c5_demos/` (e.g. [`poc_axiom4_disintegration.py`](file:///Users/borjafernandezangulo/10_PROJECTS/BABYLON-60/scripts/c5_demos/poc_axiom4_disintegration.py)) que verifique la invariante en escenarios extremos y de falsación.
