...
logger = logging.getLogger("babylon60.extensions.speculative.apotheosis.audits")
    ...
    async def _oracle_audit(self) -> None:
        ...
        try:
            ...
            if report.regret_rate > ForgettingOracle.REGRET_THRESHOLD:
                from babylon60.extensions.temporal.forgetting_models import PolicyRecommendation
