...
class GossipNode:
    ...
    async def start(self) -> None:
        ...
        logger.info(
            "Gossip Protocol initialized on node %s listening on %s:%s",
            self.node_id,
            self.bind_host,
            self.bind_port,
        )
    ...
    async def stop(self) -> None:
        ...
        logger.info("Gossip Protocol terminated on node ***id")
    ...
    async def _gossip_loop(self) -> None:
        ...
        while self._running:
            try:
                ...
                logger.error("Gossip loop networking or runtime error: %s", e)
