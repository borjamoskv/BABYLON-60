...
if __name__ == "__main__":
    ...
    async def run_triad_test():
        ...
        logging.getLogger(__name__).info("--- 1. Test Jina Extract ---")
        jina_res = await triad.extract_url_jina("https://news.ycombinator.com")
        logging.getLogger(__name__).info(f"Jina: {len(jina_res)} chars recibidos. Preview: {jina_res[:100]}...\n")

        logging.getLogger(__name__).info("--- 2. Test Exa Search ---")
