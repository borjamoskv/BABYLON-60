...
class ResourceMgrMixin:
    ...
    def _init_sovereign_subsystems(self, file_config: dict) -> None:
        ...
        if self._event_bus:
            try:
                ...
                from babylon60.extensions.temporal.event_sovereignty import EventSovereigntyRuntime
    ...
    def _init_persistence_checkers(self, file_config: dict) -> None:
        ...
        try:
            ...
            self.timing_conn = connect_sync(file_config.get("db_path", str(CORTEX_DB)))
