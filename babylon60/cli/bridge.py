...
def main() -> None:
    ...
    try:
        ...
        print("🔴 [FATAL] 'cargo' no está instalado o no está en PATH. Instala Rust: https://rustup.rs", file=sys.stderr)
        sys.exit(1)
