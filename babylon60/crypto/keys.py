...
class KeyManager:
    ...
    def get_private_key_b64(self, actor_id: str) -> str | None:
        ...
        return base64.b64encode(private_key.private_bytes(encoding=serialization.Encoding.Raw, format=serialization.PrivateFormat.Raw, encryption_algorithm=serialization.NoEncryption())).decode('ascii')
    ...
    def verify_signature(public_key_b64: str, payload_hash: str, timestamp: str, signature_b64: str) -> bool:
        try:
            ...
            if len(signature) != 64:
                ...
                return False
            raw_pub_bytes = public_key.public_bytes(encoding=serialization.Encoding.Raw, format=serialization.PublicFormat.Raw)
