...
if __name__ == '__main__':
    logging.info('--- C5-REAL: ANÁLISIS TOPOLÓGICO Y ALINEAMIENTO VF2 ---')
    ...
    logging.info('Claim: Transducción Topológica Bi-direccional Verificada.')
    logging.info(f"Proof: {{ Base: 'VF2_GraphMatcher', Range: [0, 1], Confidence: 'C5-REAL', Result: {result['isomorphic']} }}")
    if result['isomorphic']:
        logging.info(f"Mapeo de Nodos: {result['mapping']}")
    logging.info(f"Fricción Termodinámica (ATP): {result['compute_time_ms']:.4f} ms")