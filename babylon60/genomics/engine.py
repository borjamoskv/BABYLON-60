...
class GenomicEvaluationEngine:
    ...
    def evaluate_loh_hrd(loh_events: int, total_regions: int, wgd_detected: bool = False) -> LOHHRDResult:
        """
        Evaluates Homologous Recombination Deficiency (HRD) score combining LOH footprint and Whole Genome Duplication.
        """
        ...
        return LOHHRDResult(
            ...
            hr_deficiency_score=round(hrd_score, 2),
    ...
    def evaluate_ecdna_amplicon(
        ...
        return ECDNAAmpliconResult(
            amplicon_id=amplicon_id,
            oncogenes=list(oncogenes),
            copy_number=copy_number,
            circular_topology_confirmed=bool(circular_confirmed),
            transcriptional_leverage=round(leverage, 4),
