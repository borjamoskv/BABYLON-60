    ...
    def summary(self) -> str:
        ...
        if self.violations:
            ...
            for v in self.violations:
                ...
                lines.append(
                    f"  {prefix} [{v.source_layer.value}→{v.target_layer.value}] {v.construct_name}: {v.message} (Rule: {v.rule})"
                )
...
class RegimeValidator:
    ...
    def validate_cross_regime(
        self, module: IRModule, target_layers: list[RegimeLayer] | None = None
