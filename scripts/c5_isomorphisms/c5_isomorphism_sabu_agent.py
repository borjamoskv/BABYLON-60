...
def main() -> None:
    ...
    if not report["isomorphism_verified"]:
        sys.exit(1)
    print(
        "\n[+] Causal-Determinist: Topological Isomorphism Verified 100%. Degree Sequence: "
        + str(report["degree_sequence"])
    )
    sys.exit(0)
