...
def main() -> None:
    ...
    legacy_test_types = ['risk_score', 'CREATED', 'append', 'Mutation', 'Ingestion', 'Update', 'Delete', 'Sync']
    taint = 'borjamoskv/2026-07-24/legacy_tests_semantic_ingestion'
    ops = 0
    t0 = time.time()
    with sqlite3.connect(db_path, timeout=5.0) as conn:
        ...
        conn.commit()
    t1 = time.time()
    logging.info(f'[*] Ingestión Semántica Legacy completada en {t1 - t0:.3f}s. Ops: {ops}')
