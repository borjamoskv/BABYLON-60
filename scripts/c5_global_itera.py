...
def global_itera():
    root = Path(".")
    exclude_dirs = {".venv", "node_modules", ".git", "target", "dist", "build", ".cortex", ".idea", ".vscode", "__pycache__"}
    exclude_exts = {".db", ".sqlite", ".sqlite3", ".db-wal", ".db-shm", ".pdf", ".png", ".jpg", ".jpeg", ".gif", ".ico", ".woff", ".woff2", ".ttf", ".eot", ".mp4", ".mp3", ".wav", ".zip", ".tar", ".gz", ".rar", ".7z", ".exe", ".dll", ".so", ".dylib", ".bin", ".dat", ".pyc", ".pyo", ".pyd"}
