...
if __name__ == "__main__":
    ...
    assert result["claim_verification"]["meets_80_percent_threshold"], (
        "FATAL: System prompt reduction below 80% invariant!"
    )
    assert result["claim_verification"]["eval_score_delta"] > 0, (
        "FATAL: Coding eval score regressed under de-scaffolding!"
    )
    print(
