...
PATTERNS = {
    ...
    "JWT_TOKEN": "eyJ[a-zA-Z0-9_-]{5,}\\.eyJ[a-zA-Z0-9_-]{5,}\\.[a-zA-Z0-9_-]{5,}",
    "GITHUB_TOKEN": "ghp_[a-zA-Z0-9]{36}",
    "GOOGLE_API": "AIza[0-9A-Za-z-_]{35}",
    "SLACK_TOKEN": "xox[baprs]-[0-9]{12}-[0-9]{12}-[a-zA-Z0-9]{24}",
    "GENERIC_SECRET": "(?i)(password|secret|api_key|access_token)[\\s:=]+[\\'\"]([^\\'\"]{8,})[\\'\"]",
}
WHITELIST_ENTROPY = [
...
WHITELIST_VALUES = {
    ...
    "dummy_key_for_stress",
    "dummy_key_for_steerability",
