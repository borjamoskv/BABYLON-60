...
def generate_go(domain_name: str, cfg: dict[str, Any], domains: list[str], primitives: list[str], modifiers: list[str], output_path: str) -> None:
...
def generate_rust(domain_name: str, cfg: dict[str, Any], domains: list[str], primitives: list[str], modifiers: list[str], output_path: str) -> None:
...
def generate_python(domain_name: str, cfg: dict[str, Any], domains: list[str], primitives: list[str], modifiers: list[str], output_path: str) -> None:
    lines = [
        f"# Auto-generated by 10_codegen_engine.py for {domain_name}. DO NOT EDIT.",
        "import math",
