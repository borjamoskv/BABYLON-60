...
const { familySync, versionSync } = require("../../detect-libc/lib/detect-libc.js");
...
if (!sharp) {
  try {
    switch (runtimePlatform) {
      case "darwin-arm64":
        sharp = require("../../@img/sharp-darwin-arm64/index.cjs");
        break;
      case "darwin-x64":
        sharp = require("../../@img/sharp-darwin-x64/index.cjs");
        break;
      case "linux-arm":
        sharp = require("../../@img/sharp-linux-arm/index.cjs");
        break;
      case "linux-arm64":
        sharp = require("../../@img/sharp-linux-arm64/index.cjs");
        break;
      case "linux-ppc64":
        sharp = require("../../@img/sharp-linux-ppc64/index.cjs");
        break;
      case "linux-riscv64":
        sharp = require("../../@img/sharp-linux-riscv64/index.cjs");
        break;
      case "linux-s390x":
        sharp = require("../../@img/sharp-linux-s390x/index.cjs");
        break;
      case "linux-x64":
        sharp = require("../../@img/sharp-linux-x64/index.cjs");
        break;
      case "linuxmusl-arm64":
        sharp = require("../../@img/sharp-linuxmusl-arm64/index.cjs");
        break;
      case "linuxmusl-x64":
        sharp = require("../../@img/sharp-linuxmusl-x64/index.cjs");
        break;
      case "win32-arm64":
        sharp = require("../../@img/sharp-win32-arm64/index.cjs");
        break;
      case "win32-ia32":
        sharp = require("../../@img/sharp-win32-ia32/index.cjs");
        break;
      case "win32-x64":
        sharp = require("../../@img/sharp-win32-x64/index.cjs");
        break;
      case "freebsd-arm64":
      case "freebsd-x64":
        sharp = require("../../@img/sharp-freebsd-wasm32/index.cjs");
        break;
      case "linux-wasm32":
        sharp = require("../../@img/sharp-webcontainers-wasm32/index.cjs");
        break;
    }
...
if (!sharp) {
  try {
    sharp = require("../../@img/sharp-wasm32/index.cjs");
  } catch (err) {
    errors.push(err);
  }
}
