...
El repositorio **`system_prompts_leaks`**, creado y mantenido por **Ásgeir Thor Johnson** (`asgeirtj@gmail.com`), actúa como un **archivo forense y registro público de ingeniería inversa** dedicado a recopilar, versionar y exponer los *system prompts*, instrucciones ocultas y esquemas de herramientas de los principales modelos de IA y arneses de codificación (Anthropic Claude Code, OpenAI, Cursor, Devin, etc.).
