...
const AXIOMS: AxiomItem[] = [
  ...
  { id: 'AX-BFT-1', name: 'Ejecución Topológica', category: 'Causal Engine', status: 'PASSED', detail: 'Orden topológico determinista' },
  { id: 'AX-BFT-4', name: 'Concurrencia Acotada', category: 'Causal Engine', status: 'PASSED', detail: 'Máx concurrencia <= 12' },
