...
- **Ω162 · FALSIFICATION POWER INVARIANT:** Toda medición debe declarar de forma destructiva qué subconjunto de hipótesis aniquila (`falsifies:`) y a cuáles refuerza (`supports:`). La "confianza" está prohibida como valor de entrada estocástico: es estrictamente una métrica emergente calculada a partir del volumen de falsaciones acumuladas.
