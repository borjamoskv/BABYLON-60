...
class TestL3InferenceEnginePhysical:
    ...
    def test_exhausted_trajectories_raises_mcts_error(self) -> None:
        ...
        import cortex.engines.mcts_vnode_compiler as compiler_mod
...
class TestCoverageEdgeCases:
    def test_shannon_entropy_without_numpy_fallback(self, monkeypatch: pytest.MonkeyPatch) -> None:
        import cortex.engines.mcts_vnode_compiler as comp
    ...
    def test_enforce_ide_theorem_physical_execution(self, tmp_path: pytest.TempPathFactory) -> None:
        from cortex.engines.mcts_vnode_compiler import enforce_ide_theorem_physical
