...
def _mk(**over: object) -> StudyFeatures:
    base = dict(nct_id='NCT0', brief_title='t', phase='PHASE3', study_type='INTERVENTIONAL', n_eligibility_criteria=30, n_inclusion=15, n_exclusion=15, n_primary_endpoints=2, n_secondary_endpoints=6, n_arms=3, enrollment=800, n_sites=40, n_countries=12, allocation='RANDOMIZED', intervention_model='PARALLEL', masking='DOUBLE', is_oncology=True, is_rare_disease=False, therapeutic_area='Oncology')
    base.update(over)
