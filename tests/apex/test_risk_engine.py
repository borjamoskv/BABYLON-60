...
def test_complex_oncology_phase3_is_high_or_critical() -> None:
    f = _mk(n_eligibility_criteria=50, n_primary_endpoints=4, n_secondary_endpoints=8, n_arms=5, enrollment=2000, n_countries=25, phase='PHASE3', intervention_model='CROSSOVER', masking='QUADRUPLE', is_oncology=True, therapeutic_area='Oncology')
    a = assess(f)
